...
from .parser import ParseResult, ImageInfo
...
class RenderResult:
    ...
    output_file: Optional[Path] = None   # Path to output HTML file
    assets_dir: Optional[Path] = None    # Path to assets directory
...
'''
    ...
    def load_theme_css(self, theme_name: Optional[str] = None) -> str:
        """
