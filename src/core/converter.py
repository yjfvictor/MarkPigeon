...
from .packer import ZipPacker, PackResult, ExportMode
...
class Converter:
    ...
    def convert_batch(
        ...
        for i, input_file in enumerate(input_files):
            ...
            file_export_mode = ExportMode.DEFAULT if export_mode == ExportMode.BATCH_ZIP else export_mode
