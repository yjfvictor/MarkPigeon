...
from ...core.converter import Converter, BatchResult, ExportMode
from ...core.i18n import I18n, get_i18n

from .components import (
    DropZone, FileListWidget, ThemeSelector, 
    ExportModeSelector, ProgressWidget
)
...
class MainWindow(QMainWindow):
    ...
    def _choose_output_dir(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            self.i18n.t('dialog.select_output'),
            str(Path.home())
        )
    ...
    def _open_folder(self):
        ...
        folder = QFileDialog.getExistingDirectory(
            self,
            self.i18n.t('dialog.select_folder'),
            str(Path.home())
        )
    ...
    def _on_conversion_finished(self, result: BatchResult):
        ...
        if result.failed == 0:
            ...
            QMessageBox.warning(
                self,
                "Warning",
                self.i18n.t('messages.conversion_failed', count=result.failed)
            )
